-- Migration: Add scraping tables
-- Description: Creates tables for storing sitemap scraping tasks and results
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'scraping_tasks_updated_at') THEN
    CREATE TRIGGER scraping_tasks_updated_at BEFORE UPDATE ON scraping_tasks 
